                        ...
                        <div class="row row-cols-1 row-cols-xl-4 row-cols-lg-2 row-cols-md-2 justify-content-center text-center" data-anime='{ "el": "childs", "translateY": [30, 0], "scale":[0.8,1], "opacity": [0,1], "duration": 500, "delay": 0, "staggervalue": 200, "easing": "easeOutQuad" }'>
                            <?php foreach ($council as $resolution): ?>
                                <?php if ($resolution['year'] === '2022'): ?>
                                    <a href="assets/downloads/council-resolution/<?= $resolution['link']; ?>" target="_blank" class="mb-20px">
                                        <div class="mb-10 h-100 bg-white border-radius-20px border box-shadow-quadruple-large border-color-extra-medium-gray ">
                                            <div class="trainer-box h-100 p-10px position-relative">
                                                ...
                                                <div class="overflow-hidden">
                                                    ...
                                                    <div class="bg-white position-relative p-10px">
                                                        <span class="text-dark-gray fw-600 d-block"><?= $resolution['name']; ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
