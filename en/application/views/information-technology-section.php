        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center justify-content-center align-content-center text-lg-start">
                <ul class="p-0 list-style-04 fs-16 fw-400 text-black mb-40px">
                    <li class="text-grey">The Information Technology Section is responsible for the co-ordination and implementation of all computer and information technology related matters.
                    </li>
                    <li class="text-grey">To help achieve the fruitful results, the work policy is developed in consultation with other sections of the corporation.
                    </li>
                </ul>
