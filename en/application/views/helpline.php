                ...
                <div>
                    <div class="card overflow-hidden mb-30px box-shadow border-radius-20px">
                        <div class="card-body p-30px">
                            <img src="assets/images/icons/<?= $contact['icons']; ?>" class="card-img-top w-80px mb-20px">
                            <h5 class="d-inline card-title fs-20 fw-700 mb-20px"><?= $contact['helpline']; ?>
                            </h5>
                            ...
                            <div class="card-footer bg-white border-0 p-0 border-top">
                                <a href="tel:<?= $contact['phone']; ?>"><i class="fa-solid fa-phone text-base-color  me-5px"></i>
