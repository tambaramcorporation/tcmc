        ...
        <div class="row g-0 mb-5 sm-mb-30px">
            <div class="col event-style-03 bg-white box-shadow-quadruple-large border-radius-20px border overflow-hidden">
                <ul class="nav nav-tabs flex-wrap flex-md-nowrap fs-17 md-fs-15 fw-500 alt-font text-center bg-base-color border-color-white">
                    <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#reform-1">REFORM - I</a></li>
                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#reform-2">REFORM - II</a></li>
                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#reform-4">REFORM - IV</a></li>
                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#reform-5">REFORM - V</a></li>
                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#reform-6">REFORM - VI</a></li>
                </ul>
