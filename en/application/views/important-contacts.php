...
<section class="pt-60px pb-60px position-relative">
    <div class="container">
        <h2 class="text-dark-gray fw-700 fs-32 mb-5 text-center">Commissioner of Municipal Administration Officials </h2>
        <div class="row row-cols-1 row-cols-xl-3 row-cols-lg-2 row-cols-md-2" data-anime='{ "el": "childs", "translateY": [30, 0], "scale":[0.8,1], "opacity": [0,1], "duration": 500, "delay": 0, "staggervalue": 200, "easing": "easeOutQuad" }'>
            <?php foreach ($administrationofficials as $contact): ?>
                <div class="col mb-30px">
                    <div class="icon-with-text-style-01 feature-box feature-box-left-icon-middle bg-white p-20px border-radius-20px h-100 text-start box-shadow-double-large">
                        <div class="feature-box-icon me-15px">
                            <img src="assets/images/logo/logo.png" class="h-60px" alt="">
                        </div>
