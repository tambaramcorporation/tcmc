        ...
        <div class="row">
            <table class="w-100 overflow-hidden border-radius-20px">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= $report['year']; ?></td>
                        <td><a href="assets/downloads/audited-financial-statement/<?= $report['revenue_fund']; ?>"
                                target="_blank"><img src="assets/images/icons/document.png" class="w-40px ms-10px">
                            </a></td>
                        <td><a href="assets/downloads/audited-financial-statement/<?= $report['water_supply_fund']; ?>"
                                target="_blank"><img src="assets/images/icons/document.png" class="w-40px ms-10px">
                            </a></td>
                        <td><a href="assets/downloads/audited-financial-statement/<?= $report['elementary_education_fund']; ?>"
                                target="_blank"><img src="assets/images/icons/document.png" class="w-40px ms-10px">
                            </a></td>
                        <td>
