    ...
    <div class="container" style="background: linear-gradient(90deg, #FDFCFB 0%, rgba(255, 234, 217, 0.50) 100%);">
        <div class="row justify-content-center">
            <div class="col-lg-6 text-center">
                <img src="assets/images/contact/contact.png" alt="" class="border-radius-20px">
            </div>
            <div class="col-lg-6 align-content-center border-radius-20px"
                style="background-image: url('assets/images/bg/e-governance-bg.png');background-repeat: no-repeat;background-position: top right;background-size: contain;"
        ...
        <div class="row">
            <div class="col tab-style-01">
                <ul class="nav nav-tabs justify-content-center border-0 text-center fs-18 alt-font fw-600">
                    <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#main_off">Main office</a></li>
