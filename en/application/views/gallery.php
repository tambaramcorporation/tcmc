                ...
                <div class="justified-gallery image-gallery-style-06"
                    ...
                    <?php for ($i = 1; $i <= 22; $i++): ?>
                        <div class="gallery-box transition-inner-all">
                            <a href="assets/images/gallery/<?php echo $i; ?>.png" data-group="lightbox-group-gallery-item-<?php echo $i; ?>" title="">
                                <div class="position-relative bg-dark-gray">
                                    <img src="assets/images/gallery/<?php echo $i; ?>.png" alt="Gallery Image <?php echo $i; ?>" />
                                    <div class="d-flex align-items-center flex-column justify-content-end h-100 w-100 gallery-hover p-45px">
                                        <i class="icon feather icon-feather-plus-square icon-very-medium text-white absolute-middle-center"></i>
                                    </div>
                                </div>
                            </a>
                        </div>
