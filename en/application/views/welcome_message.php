...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('../assets/css/tambaram.css'); ?>" />
...
<body id="zoom-text">
                ...
                <div class="row h-35px align-items-center">
                    <div class="col-12 text-end justify-content-center">
                        ...
                        <a href="screen-reader" target="_blank" class="zoom-control p-5px ms-20px"
                            ...
                            <img src="assets/images/icons/screen-reader.png" class="w-20px" />
                        </a>
    ...
    <div class="main-header h-170px background-no-repeat position-relative z-index-9" style="background-image:url('assets/images/nav-bg.png');">
        <div class="container pt-10px pb-10px position-relative z-index-3  header-top d-flex justify-content-between align-items-center">
            <div class="">
                <a href="<?= base_url(); ?>"><img src="assets/images/logo/logo-english.png" alt="Tambaram Corporation"
                        class="w-auto h-100px" /></a>
            </div>
            <div class="">
                <a href="<?= base_url(); ?>"><img src="assets/images/logo/tamilnadu.png" alt="Tamil Nadu Government "
                        class="logo w-100px" /></a>
            </div>
            <div class="">
                <img src="assets/images/logo/chief-minister.png" alt="Chief Minister of Tamil Nadu"
                    class="cm-img me-20px w-100px" />
                <img src="assets/images/logo/deputy-chief-minister.png" alt="Deputy Chief Minister of Tamil Nadu"
                    class="cm-img me-20px w-100px" />
                <img src="assets/images/logo/minister.png" alt="Minister" class="cm-img w-100px" />
            </div>
        </div>
            ...
            <div class="col-auto menu-order center-nav">
                ...
                <div class="collapse navbar-collapse justify-content-center d-flex" id="navbarNav">
                    <ul class="navbar-nav alt-font">
                        <li class="nav-item"><a href="<?= base_url() ?>" class="nav-link no-wrap text-white"><i
                                    class="d-inline fa-solid fa-house"></i>&nbsp;Home</a>
                        </li>
                        <?php foreach ($menus as $menu): ?>
                            <?php if (!empty($menu['submenus'])): ?>
                                <li class="nav-item dropdown">
                                    <a href="javascript:void(0);" class="nav-link no-wrap text-white ps-10px">
                                    ...
                                    <ul class="dropdown-menu border-radius-10px border border-color-transparent-base-color">
                                        <?php foreach ($menu['submenus'] as $submenu): ?>
                                            <li>
                                                <a href="<?= $submenu['slug']; ?>" class="border-bottom text-black ps-5px pe-5px pt-5px pb-10px">
                                                    <?= $submenu['submenu']; ?>
                                                </a>
                                            </li>
                                        <?php endforeach; ?>
                            ...
                            <?php else: ?>
                                <li class="nav-item">
                                    <a href="<?= $menu['slug']; ?>" class="nav-link no-wrap text-white"><?= $menu['menu']; ?></a>
                                </li>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </ul>
        ...
        <div class="container">
            <div class="row d-flex footer-content" style="height: 100%;">
                <div
                    ...
                    <img src="assets/images/logo/logo-english.png" alt="" class="mb-20px footer-logo"
                        style="width: 340px" />
                    <p class="fs-16 fw-400 footer-description w-100 ">
                        To make all Urban Local Body Services accessible to the common man from anywhere, anytime through various service delivery outlets and ensure efficiency, accuracy, transparency, speedy & reliability of such services, at affordable costs to the basic needs of the common man in the State of Tamil Nadu.
                    </p>
                ...
                <div
                    ...
                    <div class="row">
                        <div class="col-md-8 col-lg-8 footer-section information">
                            <h5 class="fs-20 fw-700 text-base-color mb-5px">Information</h5>
                        ...
                        <div class="col-md-4 col-lg-4 footer-section downloads">
                            <h5 class="fs-20 fw-700 text-base-color mb-5px">Downloads</h5>
                            <hr class="footer-separator" />
                            <ul class="fs-16 fw-400" style="color: var(--Gray-2, #4F4F4F);">
