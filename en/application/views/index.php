                        ...
                        <div class="row mb-6 xs-mb-8">
                            <div class="col tab-style-02">
                                <ul class="nav nav-tabs fs-18 fw-700 justify-content-left text-center border-bottom">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#tab_first1">Notification</a>
                                    </li>
                                    <li class="nav-item">
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6 d-flex align-items-center">
                    <div class="card-body p-30px pt-50px pb-50px">
                        ...
                        <div class="col">
                            <button onclick="findZone()" id="findZoneButton" class="btn btn-base-color btn-large btn-rounded">Know Your
                                Zone</button>
                            ...
                            <div id="mapModal" class="container w-700px bg-white sm-w-100 box-shadow p-30px" style="height: 80%;display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1000;">
                                ...
                                <div class="bottom-70px position-relative">
                                    ...
                                    <p class="mb-5px fs-16 fw-400 text-black">Locate your area on the map to know your zone</p>

                                    <input type="text" id="addressInput" placeholder="Enter your address" onfocus="initAutocomplete()" />
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-12 d-flex p-0 mt-20px align-content-center">
                                                <p class="mb-10px fs-20"><i class="fa-solid fa-circle-check me-10px" style="color: green;"></i>Zone details fetched successfully!</p>
                                            </div>
                                            <div class="col p-10px border-radius-20px bg-light-red mb-20px align-content-center">
                                                ...
                                                <p class="mb-10px fs-22">Your Pincode: <span class="fw-600" id="pincodeDisplay"></span></p>
                                                <p class="mb-10px fs-22">Your Zone: <span class="fw-600" id="zoneDisplay"></span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<section class="pt-60px pb-60px position-relative overflow-hidden cover-background" style="background-image: url(assets/images/bg/quick-link-bg.png);">
    <div class="container">
        ...
        <div class="row row-cols-1 row-cols-lg-3 row-cols-sm-2">
            <div class="col icon-with-text-style-03">
                <div class="bg-white h-350px shadow border-radius-20px feature-box p-8 text-start overflow-hidden justify-content-start">
