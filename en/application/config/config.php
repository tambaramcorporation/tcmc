...
|
*/
$config['base_url'] = 'http://localhost/tambaramcorporation/en/';
// $config['base_url'] = 'https://godparticles.uk/demo/tambaramcorporation/en/';
...
$config['sess_save_path'] = FCPATH . 'application/sessions'; // Path to save session files
