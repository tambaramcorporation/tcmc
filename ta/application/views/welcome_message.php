...
<body id="zoom-text">
    ...
    <div class="main-header h-170px" style="background-image:url('assets/images/nav-bg.png');">
        <div class="header-top">
            <div class="top-left">
                <a href="<?= base_url(); ?>"><img src="assets/images/logo/logo-tamil.png" alt="Tambaram Corporation"
            ...
            <div class="top-center">
                <img src="assets/images/logo/chief-minister.png" alt="Chief Minister of Tamil Nadu"
                    class="cm-img me-20px" style="width: 100px;" />
                <img src="assets/images/logo/deputy-chief-minister.png" alt="Deputy Chief Minister of Tamil Nadu"
                    class="cm-img me-20px" style="width: 100px;" />
                <img src="assets/images/logo/minister.png" alt="Minister" class="cm-img" style="width: 100px;" />
            </div>
        </div>
        <nav class="container navbar navbar-expand-lg header-light border-radius-20px p-15px d-block"
            style="background: #832D50;max-width: 1400px">
            <div class="col-auto menu-order center-nav">
                ...
                <div class="collapse navbar-collapse justify-content-center d-flex" id="navbarNav">
                    <ul class="navbar-nav alt-font">
                        <li class="nav-item"><a href="<?= base_url() ?>" class="nav-link"><i
                                    class="fa-solid fa-house"></i>&nbsp;முகப்பு</a>
                        </li>
                        <?php foreach ($menus as $menu): ?>
                            <?php if (!empty($menu['submenus'])): ?>
                                <li class="nav-item dropdown">
                                    <a href="javascript:void(0);" class="nav-link">
                                        <?= $menu['menu']; ?>&nbsp;<i class="fa-solid fa-angle-down"></i>
                                    </a>
                                    <ul class="dropdown-menu border-radius-10px border border-color-transparent-base-color">
                                        <?php foreach ($menu['submenus'] as $submenu): ?>
                                            <li>
                                                <a href="<?= $submenu['slug']; ?>" class="text-black">
                                                    <?= $submenu['submenu']; ?>
                                                </a>
                                            </li>
                                        <?php endforeach; ?>
                            ...
                            <?php else: ?>
                                <li class="nav-item">
                                    <a href="<?= $menu['slug']; ?>" class="nav-link"><?= $menu['menu']; ?></a>
                                </li>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </ul>
                ...
                <div class="d-flex mt-10px bg-white border-radius-20px">
                    <div class="fs-14 d-flex text-black ps-5px pe-5px me-10px"
                        ...
                        <p class="text-center w-150px my-0" id="zoom-text">
                            அறிவிப்பு:
                        </p>
                    </div>
        ...
        <div class="container">
            <div class="row d-flex footer-content" style="height: 100%;">
                <div
                    ...
                    <img src="assets/images/logo/logo-tamil.png" alt="" class="mb-20px footer-logo"
                        style="width: 340px" />
                ...
                <div class="col-md-12 col-lg-12 pt-10px pb-10px">
                    ...
                    <p class="mb-0 text-black text-center">Designed and developed by<a href="https://godparticles.co.in/" target="_blank" style="color: teal"> God Particles</a></p>
                </div>
