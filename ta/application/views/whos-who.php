                ...
                <?php if ($new['id'] === '1' || $new['id'] === '2' || $new['id'] === '3'): ?>
                    <div class="col text-center team-style-04 md-mb-50px">
                        <figure class="mb-0 position-relative">
                            <img src="assets/images/people/<?= $new['image']; ?>" class="border-radius-10px" alt="" />
                ...
                <div class="tab-content">
                    <div class="tab-pane fade in active show" id="tab_sec2">
                        <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 justify-content-center">
                            <?php foreach ($commissioner as $new): ?>
                                <?php if ($new['designation'] === 'துணை ஆணையர்'  || $new['designation'] === 'இணை ஆணையர்'): ?>
                                    <div class="col mb-40px">
                                        <div class="h-100 p-20px border-radius-20px box-shadow text-center" style="background: linear-gradient(360deg, #FFDFC5 0%, #FFF 61.51%);">
                                            <img
                                                src="<?= isset($new['image']) && !empty($new['image']) ? 'assets/images/people/' . $new['image'] : 'https://dummyimage.com/500x500/e2dad9/aaa'; ?>"
                                                class="mb-15px d-block mx-auto h-200px w-200px rounded-circle"
                                                alt="" />
                                            <p class="fw-700 fs-18 text-base-color text-capitalize mb-5px"><?= $new['name']; ?></p>
                                            <p class="fw-400 fs-17 text-black text-capitalize mb-5px"><?= $new['designation']; ?></p>
                                            <p class="fs-16 fw-400 text-black mb-5px"><i class="fa-solid fa-location-dot text-base-color me-5px"></i> <?= $new['address']; ?></p>
                                            <p class="fs-16 fw-400 text-black mb-5px"><i class="fa-solid fa-phone text-base-color me-5px"></i><a href="tel:+<?= $new['contact_no']; ?>" class="text-black">+<?= $new['contact_no']; ?></a></p>
                                                    ...
                                                    <div class="col mb-40px">
                                                        <div class="h-100 p-20px border-radius-20px box-shadow text-center" style="background: linear-gradient(360deg, #FFDFC5 0%, #FFF 61.51%);">
                                                            ...
                                                            <div class="ps-20px pe-20px">
                                                                ...
                                                                <p class="fs-16 fw-400 text-black mb-5px"><i class="fa-solid fa-phone text-base-color me-5px"></i><a href="tel:+<?= $new['contact_no']; ?>" class="text-black">+<?= $new['contact_no']; ?></a></p>
                                                                <p class="fs-16 fw-400 text-black mb-5px"><?= $new['partyname']; ?></p>
                                                                <p class="fs-16 fw-400 text-black mb-5px">வார்டு : <?= $new['ward_no']; ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
