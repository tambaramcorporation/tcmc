<section class="pt-100px pb-100px h-700px cover-background" style="background-image: url(assets/images/bg/banner.webp);">
        ...
        <div class="row">
                ...
                <div class="cover-background border-radius-20px border box-shadow h-650px p-15px"
                    ...
                    <div class="row mb-6 xs-mb-8">
                        <div class="col tab-style-02">
                            <ul class="nav nav-tabs fs-20 fw-700 justify-content-left text-center border-bottom">
                                <li class="nav-item">
            ...
            <div class="col-lg-4 d-flex">
                <div class="card flex-fill border-radius-20px box-shadow h-650px p-5px">
                    <img src="assets/images/vot.png" class="card-img-top border-radius-top-left" />
                    <div class="card-body">
                        ...
                        <?php foreach ($commissioner as $new): ?>
                            <?php if ($new['id'] === '1' || $new['id'] === '2' || $new['id'] === '3'): ?>
                                <div class="swiper-slide">
                                    <div class="card flex-fill border-radius-20px box-shadow h-650px p-5px">
                                        <img src="assets/images/people/<?= $new['image']; ?>"
...
<section class="pt-60px pb-60px">
    <div class="container">
        <div class="card zone-card border border-radius-20px overflow-hidden cover-background" style="background-image: url(assets/images/bg/zone-bg.png);">
            <div class="row g-0">
                <div class="col-md-5">
                    <img src="assets/images/zone-bg.png" class="h-100 img-fluid rounded-start border-radius-left-20px">
                </div>
                <div class="col-md-7 d-flex align-items-center">
                    <div class="card-body p-30px pt-50px pb-50px">
                        ...
                        <div class="zone-select d-flex align-center-item">
                            <label for="zoneSelect" class="align-content-center fs-16 fw-400 form-label w-100">மண்டலத்தைத் தேர்ந்தெடுக்கவும்
                            </label>
                        ...
                        <div class="row pt-20px pb-20px row-cols-1 row-cols-lg-3 row-cols-sm-2">
                                ...
                                <a href="#" id="link1" onclick="checkZoneSelection(event, 'link1')" target="_blank">
                                    <div class="feature-box align-item-left">
                                        <div class="feature-box-icon">
                                            <img src="assets/images/icons/1.png" class="w-80px p-10px" />
                                        </div>
                                        <div class="feature-box-content">
                                            <span
                                                class="d-inline-block fw-500 text-dark-gray mb-5px fs-16">வார்டு வரைபடம்</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col icon-with-text-style-03">
                                <a href="#" id="link2" onclick="checkZoneSelection(event, 'link2')" target="_blank">
                                    <div class="feature-box">
                                        <div class="feature-box-icon">
                                            <img src="assets/images/icons/2.png" class="w-80px p-10px" />
                                        </div>
                                        <div class="feature-box-content">
                                            <span class="d-inline-block fw-500 text-dark-gray mb-5px fs-16">குடிநீர் விநியோகம்</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col icon-with-text-style-03">
                                <a href="#" id="link3" onclick="checkZoneSelection(event, 'link3')" target="_blank">
                                    <div class="feature-box">
                                        <div class="feature-box-icon">
                                            <img src="assets/images/icons/3.png" class="w-80px p-10px" />
                                        </div>
                                        <div class="feature-box-content">
                                            <span class="d-inline-block fw-500 text-dark-gray mb-5px fs-16">கழிவு மேலாண்மை
                                            </span>
                                        </div>
                                    </div>
                                </a>
                        ...
                        <div class="col">
                            <button onclick="findZone()" id="findZoneButton" class="btn btn-base-color btn-large btn-rounded">மண்டலத்தை தெரிந்து கொள்ள</button>
                            <a href="javascript:void(0)" onclick="highlightButton()" class="">
                                <i class="fa-solid fa-arrow-left-long me-5px"></i>உங்கள் மண்டலத்தை அறிய இங்கே கிளிக் செய்யவும்
                            </a>
                            <!-- Modal for Google Map -->
                            <div id="mapModal" class="container w-700px bg-white sm-w-100 box-shadow p-30px" style="height: 80%;display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1000;">
                                <div class="w-100px h-100px p-15px position-relative bottom-70px box-shadow border border-radius-100 bg-white">
                                    <img src="assets/images/success.png" class="w-70px h-70px" alt="">
                                </div>
                                <div class="bottom-70px position-relative">
                                    <button onclick="closeMap()" class="d-flex w-100 justify-content-end bg-white border-0">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-12 d-flex p-0 mt-20px align-content-center">
                                                <p class="mb-10px fs-20"><i class="fa-solid fa-circle-check me-10px" style="color: green;"></i>மண்டல விவரங்கள் வெற்றிகரமாக பெறப்பட்டது!</p>
                                            </div>
                                            <div class="col p-10px border-radius-20px bg-light-red mb-20px align-content-center">
                                                <p class="mb-10px fs-22">உங்கள் பின்கோடு: <span class="fw-600" id="pincodeDisplay"></span></p>
                                                <p class="mb-10px fs-22">உங்கள் மண்டலம்: <span class="fw-600" id="zoneDisplay"></span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<section class="pt-60px pb-60px position-relative cover-background" data-parallax-background-ratio="0.5"
    style="background-image: url(assets/images/glance-bg.png);">
    <div class="container">
        <div class="card border-none" style="background: none">
            <div class="row align-items-center">
                <div class="col-md-4">
                    <div class="logo mb-20px">
                        <img src="assets/images/logo/logo.png" alt="" style="width: 80px;">
                    </div>
                            ...
                            <div class="col transition-inner-all">
                                <div class="feature-box text-align-left">
                                    <div class="d-flex align-items-center w-100 p-10px mb-30px">
                                        <div class="feature-box-icon me-5px bg-white p-10px border-radius-20px w-100px h-100px">
                                            <img src="<?= $areaglance['icon']; ?>" class="w-80px h-80px p-5px" />
                                        </div>
                                        <div class="feature-box-content ms-10px" style="width: 60%;">
                                            <span
...
<section class="pt-60px pb-60px position-relative overflow-hidden">
    <div class="container">
                    ...
                    <div class="bg-white text-center position-relative border-radius-20px box-shadow-quadruple-large overflow-hidden"
                        ...
                        <figure class="m-0 pb-20px">
                            <a href="<?= $tax['link']; ?>" target="_blank" class="position-relative d-block">
                                <img src="<?= base_url(); ?><?= $tax['image']; ?>" alt="" class="p-10px" />
                            </a>
                            <figcaption class="w-100 position-absolute bottom-0px bg-base-color"
                                ...
                                <div
                                    ...
                                    <img src="assets/images/icons/<?= $tax['icons']; ?>"
...
<section class="pt-60px pb-60px position-relative overflow-hidden cover-background" style="background-image: url(assets/images/bg/quick-link-bg.png);">
    <div class="container">
        <div class="row justify-content-center mb-30px">
            <div class="col-md-8 text-center"
                data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
        ...
        <div class="row row-cols-1 row-cols-lg-3 row-cols-sm-2">
            <div class="col icon-with-text-style-03">
                <div class="bg-white h-400px shadow border-radius-20px feature-box p-8 text-start overflow-hidden justify-content-start">
                    <div class="feature-box-icon mb-15px">
                        <img src="assets/images/icons/13.png" class="w-70px" alt="">
                    </div>
                    <div class="feature-box-content last-paragraph-no-margin">
                        ...
                        <p class="fs-14 fw-400 text-black mb-5px">
                            இந்த வலைத்தளம் தமிழ்நாடு முழுவதும் உள்ள நகராட்சிகள் மற்றும் மாநகராட்சிகளுக்கு (சென்னை தவிர) ஆன்லைன் வரி சேவைகளை வழங்குகிறது.
                        </p>
                        <a href="https://tnurbanepay.tn.gov.in/" target="_blank"
                            class="btn btn-small btn-rounded bg-base-color text-white text-base-color-hover mt-20px border">பணம் செலுத்த</a>
                    </div>
                </div>
            </div>
            <div class="col icon-with-text-style-03">
                <div class="bg-white h-400px shadow border-radius-20px feature-box p-8 text-start overflow-hidden justify-content-start">
                    <div class="feature-box-icon mb-15px">
                        <img src="assets/images/icons/14.png" class="w-70px" alt="">
                    </div>
                    <div class="feature-box-content last-paragraph-no-margin">
                            ...
                            <?php foreach ($quick as $link): ?>
                                <?php if ($link['filter'] === 'quick-link'): ?>
                                    <li class="d-flex align-items-center">
                                        <img src="assets/images/icons/arrow-right.png" class="me-10px" />
            ...
            <div class="col icon-with-text-style-03">
                <div class="bg-white h-400px shadow border-radius-20px feature-box p-8 text-start overflow-hidden justify-content-start">
                    <div class="feature-box-icon mb-15px">
                        <img src="assets/images/icons/15.png" class="w-70px" alt="">
                    </div>
                    <div class="feature-box-content last-paragraph-no-margin">
                        <span class="d-inline-block tabs fs-20 fw-700 text-base-color mb-10px">சுற்றுலா மற்றும் பாரம்பரியம்</span>
                        <ul class="list-style-02 ps-0  lh-40">
                            <?php foreach ($quick as $link): ?>
...
<section class="pt-60px pb-60px bg-white position-relative overflow-hidden">
    <div class="container">
        <div class="row justify-content-center mb-30px">
            <div class="col-md-8 text-center"
                data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <h2 class="alt-font fs-30 fw-700 mb-10px text-dark-gray">இன்ஸ்ட்டாகிராம் புதுப்பிப்புகள்</h2>
            </div>
        </div>
            ...
            <?php foreach (array_slice($news, 0, 6) as $updates): ?>
                <div class="col interactive-banner-style-07">
                    <figure
                        ...
                        <img src="assets/images/news/<?= $updates['image']; ?>" alt="" />
                        <figcaption>
                            <div
        ...
        <div class="col justify-content-center align-content-center mt-5 d-flex btn-dual">
            <a href="instagram_updates"
                class="btn btn-base-color btn-large btn-rounded d-table d-lg-inline-block lg-mb-15px md-mx-auto">மேலும் காண</a>
        </div>
    </div>
</section>
<!-- Daily updates -->
...
<section class="pt-60px pb-60px bg-very-light-gray"
