...
<section class="pt-60px pb-60px contain-background background-no-repeat background-position-right" style="background-image: url(assets/images/bg/officer-details-bg.png);background-size:200px">
    <div class="container">
        <div class="row row-cols-1 row-cols-xl-3 row-cols-md-3 row-cols-sm-2 justify-content-center" data-anime='{ "el": "childs", "translateX": [30, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                                ...
                                <div class="atropos-rotate">
                                    <div class="atropos-inner">
                                        <figure class="m-0 hover-box border-radius-8px overflow-hidden position-relative" data-atropos-offset="3">
                                            <img class="w-100" src="assets/images/place of interest/<?= $place['image']; ?>" alt="" />
                                            <figcaption class="d-flex flex-column align-items-start justify-content-end position-absolute left-0px top-0px w-100 h-100 z-index-1 ps-20px">
...
<?php foreach ($places as $place): ?>
    <section id="<?= $place['scroll']; ?>" class="pt-40px pb-40px">
        <div class="container" data-anime='{ "el": "childs", "translateX": [30, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        ...
                        <div class="row">
                            <div class="col-md-3 text-center d-flex align-item-center justify-content-center">
                                <div class="d-flex align-items-center w-100">
                                    <p class="fs-20 fw-700 mb-0 text-base-color">தாம்பரம்</p>
                                </div>
                            </div>
                            <div class="col-lg-6 text-center divider-style-01">
                                <div class="divider-border d-flex align-items-center w-100">
                                    <span class="d-flex flex-column justify-content-center w-90px h-90px box-shadow-extra-large rounded-circle">
