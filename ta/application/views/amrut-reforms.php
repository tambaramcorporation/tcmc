...
<section class="pt-60px pb-60px contain-background background-no-repeat background-position-right" style="background-image: url(assets/images/bg/officer-details-bg.png);background-size:200px">
    <div class="container">
        <div class="row g-0 mb-5 sm-mb-30px">
            <div class="col event-style-03 bg-white box-shadow-quadruple-large border-radius-20px border overflow-hidden">
                <ul class="nav nav-tabs flex-wrap flex-md-nowrap fs-17 md-fs-15 fw-500 alt-font text-center bg-base-color border-color-white">
                    <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#reform-1">சீர்திருத்தம் - I</a></li>
                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#reform-2">சீர்திருத்தம் - II</a></li>
                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#reform-4">சீர்திருத்தம் - IV</a></li>
                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#reform-5">சீர்திருத்தம் - V</a></li>
                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#reform-6">சீர்திருத்தம் - VI</a></li>
                </ul>
                                ...
                                <?php if ($downloads['reforms'] === 'REFORM -I'): ?>
                                    <?php if (!empty($downloads['link'])): ?>
                                        ...
                                        <?php else: ?>
                                            <div class="mb-20px">
                                            <?php endif; ?>
                                            <div class="trainer-box h-100 p-10px bg-white border-radius-20px border box-shadow-quadruple-large border-color-extra-medium-gray position-relative">
                                                <span class="fs-12 lh-24 fw-600 text-white bg-base-color d-inline-block border-radius-26px position-absolute top-minus-13px z-index-1 right-15px ps-10px pe-10px">
                                                    <i class="fa-solid fa-cloud-arrow-down text-white"></i>
                                                </span>
                                                <div class="overflow-hidden">
                                                        <img src="assets/images/icons/document.png" class="w-60px">
